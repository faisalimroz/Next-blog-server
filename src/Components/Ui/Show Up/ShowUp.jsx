        ...
        <div className='mt-10'>
            <div className='flex lg:flex-row flex-col gap-4 items-center justify-center mx-auto w-[90%]'>
                ...
                <div className='relative'>
                    <Image className='w-[400px] h-[400px] filter brightness-50' src={image1} alt="Women Fashion" />
                ...
                <div className='relative'>
                    <Image className='w-[400px] h-[400px] filter brightness-50' src={image2} alt="Men Fashion" />
                    <div className='absolute top-9 left-0 w-full h-full flex flex-col justify-center items-center px-4 text-center text-white'>
                ...
                <div className='relative'>
                    <Image className='w-[400px] h-[400px] filter brightness-50' src={image3} alt="Footwear Fashion" />
                    <div className='absolute top-9 left-0 w-full h-full flex flex-col justify-center items-center px-4 text-center text-white'>
